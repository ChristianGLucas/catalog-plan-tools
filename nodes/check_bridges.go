...
func CheckBridges(ctx context.Context, ax axiom.Context, input *gen.CheckBridgesInput) (*gen.PlanResult, error) {
	...
	for _, p := range pairs {
		for _, s := range []*gen.PlanStep{p.from, p.to} {
